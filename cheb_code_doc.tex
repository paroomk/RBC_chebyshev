...
\begin{document}
  ...
  \section{Governing Equations}
    ...
    \end{align}
    \begin{align}
     \frac{\partial \bar{u}}{\partial t} = \nu_{0} {\partial_{y}}^{2}  \bar{u} + \partial_{y} \overline{uv}.
    \end{align}
...
for $k_x = 0$.
  ...
  \subsection{$y$-Discretization}
    ...
    \begin{align}
     \partial_{y}^{2}\bar{u} &= \mathbf{T}_{N}\lr{y}\wh{\mathbf{c}}.
    \end{align}
    ...
    \begin{align}
    &\partial_{y}\bar{u} = D\mathbf{U}\lr{y}\wh{\mathbf{c}} \\
    &\bar{u} = \mathbf{U}\lr{y}\wh{\mathbf{c}}.
    \end{align}
    ...
    The mean flow equation~\eqref{eq:meanflow_l} using the Chebyshev expansions becomes,
