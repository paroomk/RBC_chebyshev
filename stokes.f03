...
real(dp), allocatable, dimension(:,:)    :: PTM, PD2TM ! Projected Galerkin for T-eq
...
real(dp), parameter                      :: t_final = 20.0_dp
real(dp), parameter                      :: dt      = 0.5_dp
real(dp)                                 :: temp
...
call projectVT(GPVM,GPD2VM,GPD4VM,GPTM,PTM,PD2TM,PVEL, Pmj,Cjm,VM,D2VM,TM)
